...
output_base_dir = "C:/git/image-segmentation/dataset/base_segmentadas"
extensao_imagem = ".JPG"
extensao_JSON = ".json"
...
def criar_imagem_segmentada(imagem_original, dados_json, output_path, label, index, filename):
    ...
    for index, shape in enumerate(dados_json["shapes"]):
        ...
        cor = class_to_color.get(label, (255, 255, 255))  # Obtém a cor da classe ou branco se não encontrada
